...
try {leitungLog = await client.channels.fetch(LEITUNG_LOG_CHANNEL_ID);} catch {}

if (leitungLog) {await leitungLog.send({ embeds: [logEmbed] });}
...
📌 Hinweis: Nur mit der Rolle PraktiSani klickbar.🕒 Report: Sonntag 19:25 · Reset: Sonntag 19:30
...
if (interaction.customId === "p1") {amount = 1;reason = "Bewerber eingestellt";}

if (interaction.customId === "p2") {amount = 2;reason = "Alleine fahren Prüfung";}

if (interaction.customId === "p3") {amount = 3;reason = "Sanitäter Prüfung";}
...
if (amount === 2) {color = 0x3498DB;emoji = "🔵";}
